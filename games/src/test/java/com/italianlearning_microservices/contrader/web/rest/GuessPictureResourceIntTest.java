...
import com.italianlearning_microservices.contrader.domain.Categpry;
...
public class GuessPictureResourceIntTest {
    ...
    public static GuessPicture createEntity(EntityManager em) {
        ...
        // Add required entity
        Categpry categpry = CategpryResourceIntTest.createEntity(em);
        em.persist(categpry);
        em.flush();
        guessPicture.setCategpry(categpry);
        // Add required entity
