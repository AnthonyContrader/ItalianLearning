...
import com.italianlearning_microservices.contrader.repository.CategoriesRepository;
import com.italianlearning_microservices.contrader.service.CategoriesService;
import com.italianlearning_microservices.contrader.service.dto.CategoriesDTO;
import com.italianlearning_microservices.contrader.service.mapper.CategoriesMapper;
...
public class CategoriesResourceIntTest {
    ...
    public void createCategories() throws Exception {
        ...
        assertThat(testCategories.getTitle()).isEqualTo(DEFAULT_TITLE);
    ...
    public void updateCategories() throws Exception {
        ...
        Categories testCategories = categoriesList.get(categoriesList.size() - 1);
        assertThat(testCategories.getTitle()).isEqualTo(UPDATED_TITLE);
