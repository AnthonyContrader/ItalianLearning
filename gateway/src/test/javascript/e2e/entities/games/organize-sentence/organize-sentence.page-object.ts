...
export class OrganizeSentenceComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    title = element.all(by.css('jhi-organize-sentence div h2#page-heading span')).first();
...
export class OrganizeSentenceUpdatePage {
    pageTitle = element(by.id('jhi-organize-sentence-heading'));
