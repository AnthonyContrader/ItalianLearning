...
export class HangmanComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    title = element.all(by.css('jhi-hangman div h2#page-heading span')).first();
...
export class HangmanUpdatePage {
    pageTitle = element(by.id('jhi-hangman-heading'));
