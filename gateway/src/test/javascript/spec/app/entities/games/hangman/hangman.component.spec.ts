...
import { HangmanComponent } from 'app/entities/games/hangman/hangman.component';
...
describe('Component Tests', () => {
    describe('Hangman Management Component', () => {
        let comp: HangmanComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HangmanComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.hangmen[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
