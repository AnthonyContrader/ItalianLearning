...
import { FindAWordComponent } from 'app/entities/games/find-a-word/find-a-word.component';
...
describe('Component Tests', () => {
    describe('FindAWord Management Component', () => {
        let comp: FindAWordComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FindAWordComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.findAWords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
