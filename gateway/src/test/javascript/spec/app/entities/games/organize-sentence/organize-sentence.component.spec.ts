...
import { OrganizeSentenceComponent } from 'app/entities/games/organize-sentence/organize-sentence.component';
...
describe('Component Tests', () => {
    describe('OrganizeSentence Management Component', () => {
        let comp: OrganizeSentenceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OrganizeSentenceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.organizeSentences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
