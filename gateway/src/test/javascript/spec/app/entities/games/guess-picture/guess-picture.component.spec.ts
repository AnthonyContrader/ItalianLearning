...
import { GuessPictureComponent } from 'app/entities/games/guess-picture/guess-picture.component';
...
describe('Component Tests', () => {
    describe('GuessPicture Management Component', () => {
        let comp: GuessPictureComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GuessPictureComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.guessPictures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
