...
import { GamePlaylistComponent } from 'app/entities/games/game-playlist/game-playlist.component';
...
describe('Component Tests', () => {
    describe('GamePlaylist Management Component', () => {
        let comp: GamePlaylistComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GamePlaylistComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.gamePlaylists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
